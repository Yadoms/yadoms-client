...
export class WebSocketService {
     ...
     */
    public onConnectStateChange!: (result: boolean, code?: number, reason?: string) => void;
    /**
    ...
    private notifySuccess<T>(uuid: string, data: T) {
        if (uuid != undefined && uuid != null && this.commandCallbacks.has(uuid) && this.commandCallbacks.get(uuid) != null) {
